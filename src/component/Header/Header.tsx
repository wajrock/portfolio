  ...
  return (
    <div className="header">
      ...
      <div className="header__right">
        <a href={`${process.env.PUBLIC_URL}/wajrock-cv-`+lang+'.pdf'}  target="_blank" className="cta" rel="noreferrer">
      ...
      {menuOpen && (
        <div className="phone-menu">
          ...
          <a href={`${process.env.PUBLIC_URL}/wajrock-cv-`+lang+'.pdf'}  target="_blank" className="phone-menu-cta" rel="noreferrer">
            <div className="get-resume">
              {lang === "en" ? (<p>Get my CV</p>) : (<p>Voir mon CV</p>)}
            </div>
          </a>
