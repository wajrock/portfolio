...
const ToolsSection: FunctionComponent<{ id: string; lang: string }> = ({id,lang,}) => {
  ...
  const itemRef6 = useRef<HTMLDivElement>(null)

  const isVisible = useOnScreen(headerRef)

  const item1Visible = useOnScreen(itemRef1)
  const item2Visible = useOnScreen(itemRef2)
  const item3Visible = useOnScreen(itemRef3)
  const item4Visible = useOnScreen(itemRef4)
  const item5Visible = useOnScreen(itemRef5)
  const item6Visible = useOnScreen(itemRef6)
    ...
    <div className="tools-section" id={id}>
      ...
      <div className="tools-section-grid tools-grid" >
        ...
        <div className="tools-grid-item" ref={itemRef6}>
          ...
          <div className="tools-grid-item-texts">
            <h2 className="tools-grid-item-texts-title">Notion</h2>
            <p className="tools-grid-item-texts-description">{lang === "en" ? "To track the progress of your project and ensure delivery." : "Pour suivre l'avancement de votre projet et garantir sa livraison."}</p>
          </div>
